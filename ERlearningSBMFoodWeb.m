...
function[graphFinTot, IniFinTot, timeERFinTot, lvFinTot, paramFinTot, paramSBMFinTot]=ERlearningSBMFoodWeb(D,A,I,k0,par0,parKn,parEq,Gsel,SBMblock)
n=size(D,1);
nIni=size(par0{1},2);
nImp=size(par0{2},2);
nInh=size(par0{3},2);
...
%-------------Etape R-----------------
    ...
    AdjImp=ltoA(Gapp(find(Gapp(:,3)==1),[1 2 4]),n,1);
